...
2. Clone your fork: `git clone https://github.com/your-username/trusted-proxies.git`
...
### Installation
```bash
git clone https://github.com/laravel-foundry/trusted-proxies.git
cd trusted-proxies
composer install
```
...
namespace LaravelFoundry\ExampleNamespace;
